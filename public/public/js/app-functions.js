...
(function ($) {
                ...
                .ajaxForm({
                    ...
                    success: function (result) {
                        ...
                        if (result.success != false && !result.pending) {
                            ...
                            $(".no-updates").remove();
                            $(
                                "#removePhoto, #dateScheduleContainer, #removeEpub"
                            ).hide();
    ...
    $("#contentLocked").on("click", function () {
        if ($(this).hasClass("unlock")) {
            ...
            $(this)
                .html(
                    '<i class="feather icon-unlock f-size-20 align-bottom"></i>'
                )
                .addClass("unlock");
        }
    });
    ...
    // Handle multiple upload button click
    ...
    $("#fileZip").on("change", function () {
        ...
        if (
            ...
            if ($(this).val()) {
                ...
                $("#previewImage").html(
                    "<strong><em>" + oFile.name + "</em></strong>"
                );
                $("#removePhoto").show();
            }
        } else {
    ...
    $(document).on("click", ".actionAcceptLive", function (s) {
        ...
        element
            .find("i")
            .addClass("spinner-border spinner-border-sm align-middle");
