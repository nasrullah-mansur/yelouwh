    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 second">
          ...
          <p class="text-white text-center-sm">Yelouwh.com — Your ultimate platform to create, share, and grow. Turn your content into cash, reach a wider audience, and build your personal brand — all in one place. Start now and watch your success unfold!</p>
          <p>
    ...
    <div class="container">
        <div class="btn-block text-center mb-5">
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="text-center">
                ...
                <p class="text-muted mt-1">Turn your passion into profit! Join today and start monetizing your skills effortlessly.</p>
              </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="text-center">
              ...
              <p class="text-muted mt-1">Get started in seconds — no fees, no hassle. Your journey to success begins here!</p>
            </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="text-center">
            ...
            <p class="text-muted mt-1">Unleash your creativity! Share valuable content that captivates your audience.</p>
          </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="col-12 col-lg-5">
        ...
        <div class="col-lg-9 col-xl-8 p-0">
          <p class="py-4 m-0 text-muted">Set up your profile quickly and effortlessly — no tech skills needed. Get ready to showcase your talent to the world!</p>
        </div>
