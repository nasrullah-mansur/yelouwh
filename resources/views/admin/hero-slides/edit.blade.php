...
<h5 class="mb-4 fw-light">
    ...
    <i class="bi-chevron-right me-1 fs-6"></i>
    <span class="text-muted">Edit: {{ $heroSlide->title }}</span>
</h5>
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow-custom border-0">
                <div class="card-body p-lg-4">
                    ...
                    <form method="POST" action="{{ route('hero-slides.update', $heroSlide) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="3" required>{{ old('description', $heroSlide->description) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="badge_icon" name="badge_icon" 
                                                           value="{{ old('badge_icon', $heroSlide->badge_icon) }}" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="badge_text" name="badge_text" 
                                                           value="{{ old('badge_text', $heroSlide->badge_text) }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="primary_button_text" name="primary_button_text" 
                                                           value="{{ old('primary_button_text', $heroSlide->primary_button_text) }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="primary_button_url" name="primary_button_url" 
                                                           value="{{ old('primary_button_url', $heroSlide->primary_button_url) }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="primary_button_icon" name="primary_button_icon" 
                                                           value="{{ old('primary_button_icon', $heroSlide->primary_button_icon) }}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="secondary_button_text" name="secondary_button_text" 
                                                           value="{{ old('secondary_button_text', $heroSlide->secondary_button_text) }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="secondary_button_url" name="secondary_button_url" 
                                                           value="{{ old('secondary_button_url', $heroSlide->secondary_button_url) }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="secondary_button_icon" name="secondary_button_icon" 
                                                           value="{{ old('secondary_button_icon', $heroSlide->secondary_button_icon) }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div id="stats-container">
                                            @if($heroSlide->hasStats())
                                                @foreach($heroSlide->stats as $index => $stat)
                                                    <div class="stat-item row mb-3">
                                                        <div class="col-md-6">
                                                            <label class="form-label">Number</label>
                                                            <input type="text" class="form-control" name="stats[{{ $index }}][number]" value="{{ $stat['number'] }}">
                                                        </div>
                                                        <div class="col-md-6">
                                    ...
                                    <div class="card-body">
                                        <div id="features-container">
                                            @if($heroSlide->hasFeatures())
                                                @foreach($heroSlide->features as $index => $feature)
                                                    <div class="feature-item row mb-3">
                                                        <div class="col-md-4">
                                                            <label class="form-label">Icon</label>
                                                            <input type="text" class="form-control" name="features[{{ $index }}][icon]" value="{{ $feature['icon'] }}">
                                                        </div>
                                                        <div class="col-md-8">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="testimonial_text" name="testimonial[text]" rows="3" 
                                                      placeholder="This platform changed my life...">{{ old('testimonial.text', $heroSlide->testimonial['text'] ?? '') }}</textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="testimonial_author_name" 
                                                           name="testimonial[author_name]" value="{{ old('testimonial.author_name', $heroSlide->testimonial['author_name'] ?? '') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="testimonial_author_title" 
                                                           name="testimonial[author_title]" value="{{ old('testimonial.author_title', $heroSlide->testimonial['author_title'] ?? '') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            @if(!empty($heroSlide->testimonial['author_image']))
                                                <div class="mt-2">
                                                    <small class="text-muted">Current image: {{ $heroSlide->testimonial['author_image'] }}</small>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="sort_order" name="sort_order" 
                                                   value="{{ old('sort_order', $heroSlide->sort_order) }}" min="0" required>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            @if($heroSlide->background_image)
                                                <div class="mt-2">
                                                    <img src="{{ $heroSlide->background_image_url }}" alt="Current background" 
                                                         class="img-thumbnail" style="max-width: 200px;">
                                                    <br><small class="text-muted">Current: {{ $heroSlide->background_image }}</small>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if($heroSlide->hero_image)
                                                <div class="mt-2">
                                                    <img src="{{ $heroSlide->hero_image_url }}" alt="Current hero" 
                                                         class="img-thumbnail" style="max-width: 200px;">
                                                    <br><small class="text-muted">Current: {{ $heroSlide->hero_image }}</small>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi-check2 me-1"></i> Update Slide
                                    </button>
...
@section('javascript')
<script>
let statIndex = {{ $heroSlide->hasStats() ? count($heroSlide->stats) : 1 }};
let featureIndex = {{ $heroSlide->hasFeatures() ? count($heroSlide->features) : 1 }};
