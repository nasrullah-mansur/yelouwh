                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                                                               id="icon" name="icon" value="{{ old('icon', 'fas fa-folder') }}" required>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('color_scheme') is-invalid @enderror" 
                                                        ...
                                                        <option value="popular" {{ old('color_scheme') === 'popular' ? 'selected' : '' }}>Popular (Red)</option>
                                                        <option value="featured" {{ old('color_scheme') === 'featured' ? 'selected' : '' }}>Featured (Orange)</option>
                                                        <option value="active" {{ old('color_scheme') === 'active' ? 'selected' : '' }}>Active (Purple)</option>
                                                        <option value="new" {{ old('color_scheme') === 'new' ? 'selected' : '' }}>New (Teal)</option>
                                                        <option value="free" {{ old('color_scheme') === 'free' ? 'selected' : '' }}>Free (Blue)</option>
                                                        <option value="others" {{ old('color_scheme') === 'others' ? 'selected' : '' }}>Others (Gray)</option>
                                                        <option value="default" {{ old('color_scheme', 'default') === 'default' ? 'selected' : '' }}>Default (Orange)</option>
                                                    </select>
                                                    @error('color_scheme')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('category_type') is-invalid @enderror" 
                                                ...
                                                <option value="regular" {{ old('category_type', 'regular') === 'regular' ? 'selected' : '' }}>Regular</option>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('badge_type') is-invalid @enderror" 
                                                ...
                                                <option value="default" {{ old('badge_type', 'default') === 'default' ? 'selected' : '' }}>Default</option>
                                                <option value="new" {{ old('badge_type') === 'new' ? 'selected' : '' }}>New</option>
                                                <option value="free" {{ old('badge_type') === 'free' ? 'selected' : '' }}>Free</option>
                                                <option value="premium" {{ old('badge_type') === 'premium' ? 'selected' : '' }}>Premium</option>
                                    ...
                                    <div class="card-body">
                                        <div id="category-preview" class="category-card-preview">
                                            <div class="preview-image">
                                                <img src="{{ asset('public/new_home_page/sports.jpg') }}" alt="Preview">
                                            ...
                                            <div class="preview-content">
                                                ...
                                                <div class="preview-badge" style="display: none;">New</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
